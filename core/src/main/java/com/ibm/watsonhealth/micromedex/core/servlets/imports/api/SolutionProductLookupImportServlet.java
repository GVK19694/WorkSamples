...
@Slf4j
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=Servlet to upload solution data into AEM",
  "sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + SolutionProductLookupImportServlet.SERVLET_PATH,
  "sling.servlet.extensions=" + AbstractImportServlet.SERVLET_EXTENSION })
public class SolutionProductLookupImportServlet extends AbstractImportServlet {

    private static final String UPLOAD_SERVLET_SUBPATH = "solutionproductlookup";
